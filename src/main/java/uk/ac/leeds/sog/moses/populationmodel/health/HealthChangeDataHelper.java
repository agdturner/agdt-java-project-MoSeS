...
public class HealthChangeDataHelper {
	private PopulationDataHelper populationDataHelper;
	private static Logger s_logger = MosesLogger.getLogger(HealthChangeDataHelper.class);
	
	public HealthChangeDataHelper(PopulationDataHelper populationDataHelper) {
