 ...
 *
 * The Household Population (HP) is comprised from ISARDataRecords.
 ...
 * At least 15GB Disk for a full UK run.
 ...
 */
public class IndividualCensus_ISARHP_ISARCEP_PC extends IndividualCensus_ISARHP_ISARCEP {
        ...
        try {
            ...
            if (args.length == 0) {
                _Input_Parameter_File = new File(
                        //"/scratch01/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/OA_ISARHP_ISARCEP/2_10_2_2_2_2_0_Init.txt");
                        //"/scratch01/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/OA_ISARHP_ISARCEP/2_0_2_2_2_2_0_Init.txt");
                        "/scratch01/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/OA_ISARHP_ISARCEP/2_1000_2_2_2_2_0_1.txt");
                //"C:/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/OA_ISARHP_ISARCEP/2_10_2_2_2_2_0_Init.txt");
                //"C:/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/OA_ISARHP_ISARCEP/2_10_2_2_2_2_0_1.txt");
                //"C:/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/OA_ISARHP_ISARCEP/2_1000_2_2_2_2_0_1.txt");
                //"C:/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/OA_ISARHP_ISARCEP/2_1000_10_10_10_10_0_1.txt");
                //"C:/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/00D/00DA/OA_ISARHP_ISARCEP/2_10_2_2_2_2_0_Init.txt");
                //"C:/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/00D/00DA/OA_ISARHP_ISARCEP/2_10_2_2_2_2_0_1.txt");
                //"C:/Work/Projects/MoSeS/Workspace/ParameterFiles/UK/00D/00DA/OA_ISARHP_ISARCEP/2_1000_2_2_2_2_0_1.txt");
            } else {
                _Input_Parameter_File = new File(
                        args[0]);
            }
            IndividualCensus_ISARHP_ISARCEP_PC _IndividualCensus_ISARHP_ISARCEP_PC = new IndividualCensus_ISARHP_ISARCEP_PC(
                    _Input_Parameter_File);
            _IndividualCensus_ISARHP_ISARCEP_PC.run(args);
    ...
    public void initialOptimise() throws IOException {
        ...
        Object[] result;
        // solution is tConstraintsAndPopulation
        Object[] solution;
        Object[] population;
        BigDecimal fitness;
        for (long RecordID = _StartRecordID_EndRecordID[0]; RecordID <= _StartRecordID_EndRecordID[1]; RecordID++) {
            ...
            GeneticAlgorithm_ISARHP_ISARCEP _GeneticAlgorithm_ISARHP_ISARCEP = new GeneticAlgorithm_ISARHP_ISARCEP(
                    this,
                    aCASDataRecord);
            result = _GeneticAlgorithm_ISARHP_ISARCEP.getOptimisedResult_ObjectArray();
    ...
    public void reloadAndOptimise()
        ...
        for (long RecordID = _StartRecordID_EndRecordID[0]; RecordID <= _StartRecordID_EndRecordID[1]; RecordID++) {
            aCASDataRecord = (CASDataRecord) this._CASDataHandler.getDataRecord(RecordID);
            String aZoneCode = String.valueOf(aCASDataRecord.getZone_Code());
            GeneticAlgorithm_ISARHP_ISARCEP aGeneticAlgorithm_ISARHP_ISARCEP = new GeneticAlgorithm_ISARHP_ISARCEP(
                    this,
                    aCASDataRecord);
            ...
            fitness = aGeneticAlgorithm_ISARHP_ISARCEP.getFitness(aConstraintsAndPopulation);
            ...
            // Get result
            result = aGeneticAlgorithm_ISARHP_ISARCEP.getOptimisedResult_ObjectArray(existingSolution_TreeMap);
            solution = (Object[]) result[0];
            population = (Object[]) solution[1];
            fitness = (BigDecimal) result[1];
            _Population_HashMap.put(aZoneCode, population);
