 ...
 */
class IndividualCensus_ISARHP_ISARCEP_NGS extends IndividualCensus_ISARHP_ISARCEP_MPJ {

    public File _Input_Parameter_File;

    public IndividualCensus_ISARHP_ISARCEP_NGS() {
        _MPJRun = new MPJRun();
    }
    ...
    public void init(
        ...
        if (_CASLevel.equalsIgnoreCase("")) {
            _OutputName = "OA_ISARHP_ISARCEP" + "_" + (String) tInput_Parameters[10];
        } else {
            _OutputName = _CASLevel + "_ISARHP_ISARCEP" + "_" + (String) tInput_Parameters[10];
        }
...
//        }
    ...
    public static void main(String[] args) {
        ...
        File _Input_Parameter_File = new File(
                ...
                "OA_ISARHP_ISARCEP" + System.getProperty("file.separator") +
                "2_10_2_2_2_2_0_Init.txt");
               //"2_10_2_2_2_2_0_1.txt");
                //"2_1000_2_2_2_2_0_1.txt");
        //"2_1000_2_2_2_2_0_Init.txt");
        IndividualCensus_ISARHP_ISARCEP_NGS _IndividualCensus_ISARHP_ISARCEP_NGS = new IndividualCensus_ISARHP_ISARCEP_NGS(
                _Input_Parameter_File);
        _IndividualCensus_ISARHP_ISARCEP_NGS.run(args);
    }
    ...
    public void reloadOptimise_Slave(
        ...
        while (worktodo) {
            ...
            if (worktodo) {
                ...
                BigDecimal fitness = aGeneticAlgorithm_ISARHP_ISARCEP.getFitness(
                ...
                aResult = aGeneticAlgorithm_ISARHP_ISARCEP.getOptimisedResult_ObjectArray(existingSolution_TreeMap);
        ...
        while (worktodo) {
            ...
            if (worktodo) {
                ...
                GeneticAlgorithm_ISARHP_ISARCEP aGeneticAlgorithm_ISARHP_ISARCEP = new GeneticAlgorithm_ISARHP_ISARCEP(
                        this,
                        aCASDataRecord);
                aResult = aGeneticAlgorithm_ISARHP_ISARCEP.getOptimisedResult_ObjectArray();
                if (aResult == null) {
                    log("aResult == null");
                }
                bResult = new Object[2];
